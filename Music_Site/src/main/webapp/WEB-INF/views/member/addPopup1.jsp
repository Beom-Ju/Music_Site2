...
<script type="text/javascript">
	function result(zip_num, sido, gugun, dong) {
		opener.document.join_form.zip_num.value=zip_num;
		opener.document.join_form.address1.value=sido+" "+gugun+" "+dong;
		self.close();
	}
</script>
<style>
...
<div class="addr">
	<h1>주소 검색</h1>
	<form name="addr_form" action="join_addr_search" method="post">
